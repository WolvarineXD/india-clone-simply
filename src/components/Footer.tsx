    ...
    <footer className="bg-gray-50 border-t">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              India's Digital Public Infrastructure for a connected future
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Aadhaar</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">UPI</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">DigiLocker</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">eKYC</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">eSign</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">API References</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Developer Console</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Sandbox</a></li>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <p className="text-sm text-gray-500 text-center">&copy; {new Date().getFullYear()} IndiaStack. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
